...
for MODEL in "${MODELS[@]}"; do
    ...
    --batch_size auto \
    --num_fewshot 0 \
    --output_path results/JPT \
    --hf_hub_log_args "hub_results_org=TheFinAI,details_repo_name=lm-eval-japanese-TE-results,push_results_to_hub=True,push_samples_to_hub=True,public_repo=False" \
    --log_samples \
    --apply_chat_template \
